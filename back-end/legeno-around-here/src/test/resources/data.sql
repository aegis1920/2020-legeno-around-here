...
(id, created_at, modified_at, comment_id, content, post_id, is_read, receiver_id,
 sector_id, user_id)
VALUES (1, now(), now(), null, 'userName님, 가입을 진심으로 축하드립니다.', null, false, 9, null, null),
       (2, now() - 1, now(), null, 'userName님, 가입을 진심으로 축하드립니다.', null, false, 9, null, null),
       (3, now() - 2, now(), null, 'userName님, 가입을 진심으로 축하드립니다.', null, false, 9, null, null),
       (4, now() - 3, now(), null, 'userName님, 가입을 진심으로 축하드립니다.', null, false, 9, null, null),
       (5, now() - 4, now(), null, 'userName님, 가입을 진심으로 축하드립니다.', null, false, 9, null, null),
       (6, now() - 5, now(), null, 'userName님, 가입을 진심으로 축하드립니다.', null, false, 9, null, null),
       (7, now() - 6, now(), null, 'userName님, 가입을 진심으로 축하드립니다.', null, false, 9, null, null),
       (8, now() - 7, now(), null, 'userName님, 가입을 진심으로 축하드립니다.', null, false, 9, null, null),
       (9, now() - 8, now(), null, 'userName님, 가입을 진심으로 축하드립니다.', null, false, 9, null, null),
       (10, now() - 9, now(), null, 'userName님, 가입을 진심으로 축하드립니다.', null, false, 9, null,
        null),
       (11, now(), now(), null, 'userName님, 가입을 진심으로 축하드립니다.', null, false, 10, null, null),
       (12, now() - 1, now(), null, 'userName님, 가입을 진심으로 축하드립니다.', null, false, 10, null,
        null),
       (13, now() - 2, now(), null, 'userName님, 가입을 진심으로 축하드립니다.', null, false, 10, null,
        null),
       (14, now() - 3, now(), null, 'userName님, 가입을 진심으로 축하드립니다.', null, false, 10, null,
        null),
       (15, now() - 4, now(), null, 'userName님, 가입을 진심으로 축하드립니다.', null, false, 10, null,
        null),
       (16, now() - 5, now(), null, 'userName님, 가입을 진심으로 축하드립니다.', null, false, 10, null,
        null),
       (17, now() - 6, now(), null, 'userName님, 가입을 진심으로 축하드립니다.', null, false, 10, null,
        null),
       (18, now() - 7, now(), null, 'userName님, 가입을 진심으로 축하드립니다.', null, false, 10, null,
        null),
       (19, now() - 8, now(), null, 'userName님, 가입을 진심으로 축하드립니다.', null, false, 10, null,
        null),
       (20, now() - 9, now(), null, 'userName님, 가입을 진심으로 축하드립니다.', null, false, 10, null,
        null);
